...
++counter;});});function toggleLogoImg(id){var img=document.getElementById(id).src;if(img.indexOf('dark.png')!=-1){document.getElementById(id).src="/images/GD-dark.png";}
else{document.getElementById(id).src="/images/GD_light.png";}}
